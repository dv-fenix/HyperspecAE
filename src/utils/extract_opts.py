...
def extract_opts(parser):
    ...
    group.add('--ckpt', '-ckpt', type=str, required=True,
    help="System path to location of saved model weights.")
          
    group.add('--save_dir', '-save_dir', type=str, default="../imgs/",
    help="System path to save extracted abundances and end-members.")
